...
description: Use this test skill to verify explicit skill invocation, prompt routing, and minimal response formatting. Trigger it when a user asks to smoke test a skill, echo a short input, confirm the active skill, or validate that skill instructions are being loaded.
---
